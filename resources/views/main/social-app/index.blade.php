@php
  $pageTitle = __('index.social_media_app');
@endphp
...
@section('content')
  <div class="d-flex mb-4 mt-1">
    ...
    <div class="col">
      <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">{{ __('index.social_media_app') }}</span><span
              ...
              <table id="dt-social-media-app" class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col" >{{ __('index.app_logo') }}</th>
...
@push('scripts')
 ...
 <script src="{{ asset('vendors/datatable1.13.8/dataTables.bootstrap5.min.js') }}"></script>
  ...
  <script src="{{ asset('init/social-media-app/index.js?v=' . time()) }}"></script>
@endpush
