  ...
  <div class="card-body" id="wizard-controller">
    <div class="row">
      ...
      <div class="mb-1 col-lg-4 col-md-6 col-sm-12">
        ...
        <div class="">
          <input class="form-control" type="text" name="company_code" id="company_code" value="" placeholder="Autogenerated from name" style="text-transform: uppercase" oninput="this.value = this.value.toUpperCase().replace(/[^A-Z]/g, '')" maxlength="6">
